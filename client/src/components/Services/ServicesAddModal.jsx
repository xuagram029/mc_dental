...
const ServicesAddModal = ({modal, setModal, handleChange, addService}) => {
  return (
    <>
          <div
            ...
            <div className="relative w-auto my-6 mx-auto max-w-4xl ">
              ...
              <div className="max-h-[90vh] overflow-y-auto border-0 rounded-lg shadow-lg relative flex flex-col w-full bg-white outline-none focus:outline-none">
                ...
                <div className="relative p-6 flex-auto">
                    <div className='space-y-8'>
                        <div>
                            ...
                            <input type="text" name='service' onChange={handleChange} className='w-full p-2 border border-black rounded focus:outline-none'/>
                        </div>
                        <div>
                ...
                <div className="flex items-center justify-end p-6 border-t border-solid border-slate-200 rounded-b">
                  ...
                  <button className="px-4 py-2 text-white transition-colors duration-200 transform bg-indigo-700 rounded-md hover:bg-indigo-600 focus:outline-none focus:bg-indigo-600" onClick={addService}>
                    Add Service
                </button>
                </div>
              </div>
