...
const SwitchLogin = () => {
  ...
  return (
    <div className='bg-black h-screen w-full'>
      <img src={mcLogo} alt="MC Logo" className='w-24 absolute border-2 border-rose-300 rounded-full p-2 m-3'/>
      <div className='flex flex-col items-center justify-center h-full'>
        <h1 className='text-3xl text-white font-medium font-pop'>Who is Logging In?</h1>
        <div className='flex items-center gap-x-24 justify-center pt-24 w-full'>
